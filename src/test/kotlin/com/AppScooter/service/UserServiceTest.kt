...
import com.AppScooter.model.User
import com.AppScooter.repository.UserRepository
...
class UserServiceTest {
    ...
    val jsonString = File("./src/test/resources/App/crearUser.json").readText(Charsets.UTF_8)
